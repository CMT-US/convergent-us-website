      ...
      <section className="pt-16 pb-4">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg mx-auto text-gray-600 space-y-6">
            ...
            <p>
              <strong>Convergent US&apos;s primary goals are twofold:</strong>
            </p>
            ...
            <p>
              Convergent US has successfully sought and renewed government funding for projects that both advance 
            ...
            <p>
              Convergent US is a US owned and controlled company, staffed by US persons and capable of working 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <div className="text-gray-600 space-y-4 text-sm leading-relaxed">
                ...
                <p>
                  In 2015, Mr. Coxon formed Convergent US,
                  a &quot;C&quot; Corporation, of which he is the majority owner and President. Convergent US is dedicated 
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <div className="text-gray-600 space-y-4 text-sm leading-relaxed">
                ...
                <p>
                  At Convergent US, Curtis leads the Process Modeling area as well as program management 
                  for R&D funded work.
                </p>
              </div>
            </div>
